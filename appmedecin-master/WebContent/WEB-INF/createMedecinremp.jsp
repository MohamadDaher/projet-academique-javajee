...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>créer son compte medecin remplaçant</title>
    ...
    function condi(){
        ...
        <form id="empForm" method="post" action="createMedecinRemp">
            <fieldset>
                <legend>Compte medecin remplaçant !</legend>
                <p>Vous pouvez vous inscrire via ce formulaire.</p>

                <label for="kmmax">Kilométrage maximum de recherche de collaborateurs <span class="requis">*</span></label>
                <input type="number" id="kmmax" name="kmmax" value="<c:out value="${medrp.kmmax}"/>" size="20" maxlength="60" />
                ...
                <input type="text" id="desc" name="desc" value="<c:out value="${medrp.description}"/>" size="20" maxlength="60" />
